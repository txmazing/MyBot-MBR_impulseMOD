...
Func HaltTrigger()
	...
	If isGoldFull() And isElixirFull() And isDarkElixirFull() And ($g_iLabUpgradeProgress = 1) And ($g_iTotalBuilderCount = 0 Or $g_iTotalBuilderCount = 5) And $g_iHaltTrigger = 0 Then ; TODO ($g_iLabUpgradeProgress = 1 Or $g_iMaxCount = 32 )
		$g_iHaltTrigger = 1
		Return True

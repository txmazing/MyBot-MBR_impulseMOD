...
Global $aTabControlsStrategies, $aTabControlsBot, $aTabControlsMOD, $aTabControlsStats ; EDITED By IMMOD
...
Func InitializeControlVariables()
   ...
   Dim $aTabControlsMOD = [$g_hGUI_MOD_TAB, $g_hGUI_MOD_TAB_HUMANIZATION]; ADDED By IMMOD
   ...
   Dim $aTabControlsStats = [$g_hGUI_STATS_TAB, $g_hGUI_STATS_TAB_ITEM1, $g_hGUI_STATS_TAB_ITEM2, $g_hGUI_STATS_TAB_ITEM3, $g_hGUI_STATS_TAB_ITEM4, $g_hGUI_STATS_TAB_ITEM5]
	...
	$oAlwaysEnabledControls($g_hTabMOD) = 1 ; ADDED By IMMOD

...
Global $g_hTabMain = 0, $g_hTabLog = 0, $g_hTabVillage = 0, $g_hTabAttack = 0, $g_hTabBot = 0, $g_hTabAbout = 0, $g_hTabMOD = 0 ; ADDED By IMMOD
...
#include "impulseMOD\IMMOD GUI Design.au3" ; ADDED By IMMOD
...
;~ ------------------------------------------------------
	...
	$g_hTabMOD = GUICtrlCreateTabItem(GetTranslatedFileIni("MBR Main GUI", "Tab_06", "impulseMOD")) ; ADDED By IMMOD
...
;~ -------------------------------------------------------------
	...
	Static $g_hGUI_MOD_TAB_ImageList = 0 ; ADDED By IMMOD
	...
	Bind_ImageList($g_hGUI_MOD_TAB, $g_hGUI_MOD_TAB_ImageList) ; ADDED By IMMOD
